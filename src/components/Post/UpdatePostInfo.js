...
class UpdatePostInfo extends Component {
  ...
  componentDidMount() {
    axios
      .get(process.env.BASE_URL + "api/posts" + this.props.match.params.id)
      .then((res) => {
        this.setState({
  ...
  onDeleteClick(id) {
    axios
      .delete(process.env.BASE_URL + "api/posts" + this.props.match.params.id)
      .then((res) => {
  ...
  handleSubmit = (e) => {
    ...
    axios
      .put(
        process.env.BASE_URL + "api/posts" + this.props.match.params.id,
        data
      )
      .then((res) => {
        this.props.history.push("/blog-posts/");
                    ...
                    config={{
                      ckfinder: {
                        uploadUrl:
                          ...
                          "public/ckfinder/core/connector/php/connector.php?command=QuickUpload&type=Images&responseType=json"
                      }
                    }}
                  />
