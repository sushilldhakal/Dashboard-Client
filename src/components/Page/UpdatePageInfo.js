...
class UpdatePageInfo extends Component {
  ...
  componentDidMount() {
    axios
      .get(process.env.BASE_URL + "api/pages/" + this.props.match.params.id)
      .then((res) => {
        this.setState({
  ...
  onDeleteClick(id) {
    axios
      .delete(process.env.BASE_URL + "api/pages/" + this.props.match.params.id)
      .then((res) => {
  ...
  handleSubmit = (e) => {
    ...
    axios
      .put(
        process.env.BASE_URL + "api/pages/" + this.props.match.params.id,
        data
      )
      .then((res) => {
        this.props.history.push("/pages/");
              ...
              <Card small className="mb-3">
                <CardBody>
                  ...
                  <CKEditor
                    ...
                    config={{
                      ckfinder: {
                        uploadUrl: window.location.pathname + "backend/public"
                      }
                    }}
                  />
