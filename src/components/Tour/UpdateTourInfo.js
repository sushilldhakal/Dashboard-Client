...
class UpdateTourInfo extends Component {
  ...
  componentDidMount() {
    axios
      .get(process.env.BASE_URL + "api/tours" + this.props.match.params.id)
      .then((res) => {
        this.setState({
  ...
  onDeleteClick(id) {
    axios
      .delete(process.env.BASE_URL + "api/tours" + this.props.match.params.id)
      .then((res) => {
  ...
  handleSubmit = (e) => {
    ...
    axios
      .put(
        process.env.BASE_URL + "api/tours" + this.props.match.params.id,
        data
      )
      .then((res) => {
        this.props.history.push("/tours/");
              ...
              <Card small className="mb-3">
                <CardBody>
                  ...
                  <CKEditor
                    ...
                    config={{
                      ckfinder: {
                        uploadUrl: process.env.BASE_URL + "backend/public"
                      }
                    }}
                    // onBlur={(event, editor) => {
